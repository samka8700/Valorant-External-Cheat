...
py_IMPL_API bool     py_ImplWin32_Init(void* hwnd);
py_IMPL_API void     py_ImplWin32_Shutdown();
py_IMPL_API void     py_ImplWin32_NewFrame();
...
py_IMPL_API void     py_ImplWin32_EnableDpiAwareness();
py_IMPL_API float    py_ImplWin32_GetDpiScaleForHwnd(void* hwnd);       // HWND hwnd
py_IMPL_API float    py_ImplWin32_GetDpiScaleForMonitor(void* monitor); // HMONITOR monitor

// Transparency related helpers (optional) [experimental]
// - Use to enable alpha compositing transparency with the desktop.
// - Use together with e.g. clearing your framebuffer with zero-alpha.
py_IMPL_API void     py_ImplWin32_EnableAlphaCompositing(void* hwnd);   // HWND hwnd
